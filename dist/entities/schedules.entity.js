...
__decorate([
    (0, typeorm_1.ManyToOne)(() => realEstates_entity_1.default, (realEstate) => realEstate.schedules),
    __metadata("design:type", realEstates_entity_1.default)
], Schedule.prototype, "realEstate", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => users_entity_1.default, (user) => user.schedules),
